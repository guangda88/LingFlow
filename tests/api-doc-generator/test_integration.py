...
'''
        ...
        result = execute_skill({"input": str(test_file), "format": "json"})
...
"""
        ...
        result = execute_skill({"input": str(test_file), "framework": "flask"})
    ...
    def test_execute_skill_with_directory(self, temp_fastapi_project):
        ...
        result = execute_skill({"input": str(temp_fastapi_project), "framework": "fastapi"})
...
"""
        ...
        result = execute_skill({"input": str(test_file), "output": str(output_file), "format": "json"})
...
"""
        ...
        result = execute_skill({"input": str(test_file), "output": str(output_file), "format": "yaml"})
...
"""
        ...
        result = execute_skill(
            {"input": str(test_file), "title": "My Custom API", "version": "2.5.0", "base_url": "https://api.example.com/v1"}
        )
...
"""
        ...
        result = execute_skill({"input": str(test_file), "framework": "auto"})
...
"""
        ...
        result = execute_skill({"input": str(test_file)})
    ...
    def test_execute_skill_nonexistent_file(self):
        ...
        result = execute_skill({"input": "/nonexistent/file.py"})
...
'''
        ...
        result = execute_skill({"input": str(test_file), "framework": "flask", "title": "Products API"})
    ...
    def test_mixed_project_structure(self, temp_fastapi_project):
        ...
        result = execute_skill({"input": str(temp_fastapi_project), "framework": "fastapi", "title": "Project API"})
