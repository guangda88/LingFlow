...
all_funcs = [
    'detect_framework', 'extract_routes', 'parse_route_decorator', 'extract_parameters',
    'extract_request_body', 'extract_responses', 'extract_schemas', 'generate_openapi_spec',
    'save_document', 'execute_skill', 'scan_code', 'parse_docstring',
    'infer_type_from_annotation', 'map_flask_type', '_unparse', '_has_default',
    '_is_pydantic_model', '_is_dataclass', 'to_simple_yaml', 'RouteInfo', 'SchemaInfo',
]
