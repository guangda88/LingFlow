...
class TestOpenAPIBasicStructure:
    ...
    def test_generate_minimal_document(self):
        ...
        doc = generate_openapi_spec(routes=[], schemas={}, title="Test API", version="1.0.0", base_url="")
    ...
    def test_openapi_version(self):
        ...
        doc = generate_openapi_spec(routes=[], schemas={}, title="Any API", version="2.0.0", base_url="")

        assert doc["openapi"] == "3.0.0"

    def test_info_section(self):
        """Test info section generation"""
        doc = generate_openapi_spec(routes=[], schemas={}, title="My Awesome API", version="2.1.0", base_url="")
    ...
    def test_servers_section(self):
        ...
        doc = generate_openapi_spec(routes=[], schemas={}, title="API", version="1.0.0", base_url="http://localhost:8000")
    ...
    def test_no_servers_without_base_url(self):
        ...
        doc = generate_openapi_spec(routes=[], schemas={}, title="API", version="1.0.0", base_url="")
...
class TestPathGeneration:
    ...
    def test_single_route_path(self):
        ...
        routes = [RouteInfo(path="/users", method="GET", handler_name="get_users")]
...
class TestOperationGeneration:
    ...
    def test_operation_id(self):
        ...
        routes = [RouteInfo(path="/users", method="GET", handler_name="list_all_users", summary="List users")]
    ...
    def test_operation_not_deprecated_by_default(self):
        ...
        routes = [RouteInfo(path="/active", method="GET", handler_name="active_endpoint", deprecated=False)]
...
class TestResponseGeneration:
    ...
    def test_default_response(self):
        ...
        routes = [RouteInfo(path="/test", method="GET", handler_name="test", responses={})]
...
class TestSchemaGeneration:
    ...
    def test_multiple_schemas(self):
        ...
        schemas = {
            "User": SchemaInfo(name="User", type="object", properties={"id": {"type": "integer"}, "name": {"type": "string"}}),
            "Post": SchemaInfo(
                name="Post", type="object", properties={"id": {"type": "integer"}, "title": {"type": "string"}}
            ),
        }
    ...
    def test_realistic_api_document(self):
        ...
        routes = [
            ...
            RouteInfo(
                ...
                tags=["users"],
                request_body={"content": {"application/json": {"schema": {"$ref": "#/components/schemas/UserCreate"}}}},
...
class TestEdgeCases:
    ...
    def test_route_with_empty_tags(self):
        ...
        routes = [RouteInfo(path="/test", method="GET", handler_name="test", tags=[])]
    ...
    def test_route_with_no_parameters(self):
        ...
        routes = [RouteInfo(path="/test", method="GET", handler_name="test", parameters=[])]
    ...
    def test_special_characters_in_summary(self):
        ...
        routes = [RouteInfo(path="/test", method="GET", handler_name="test", summary="Test with \"quotes\" and 'apostrophes'")]
    ...
    def test_unicode_in_description(self):
        ...
        routes = [
            RouteInfo(path="/test", method="GET", handler_name="test", description="Description with émojis 🎉 and 中文")
        ]
