...
class TestHtmlContent:
    ...
    def test_html_escaping_in_content(self):
        ...
        components = [{"type": "card", "props": {"title": "<script>", "content": "</script>"}}]
        result = generate_html("Test", components, "default")
...
class TestHtmlEdgeCases:
    ...
    def test_html_with_unknown_component_type(self):
        ...
        components = [{"type": "navbar", "props": {}}, {"type": "unknown_type", "props": {}}, {"type": "footer", "props": {}}]
        result = generate_html("Test", components, "default")
        assert "<nav" in result
        assert "<footer" in result
    ...
    def test_html_with_malformed_component(self):
        ...
        components = [{"type": "navbar"}, None, {"props": {"text": "test"}}]  # Missing props  # None component  # Missing type
        result = generate_html("Test", components, "default")
        # Should not crash
        assert result is not None
    ...
    def test_html_with_max_components(self):
        ...
        components = [{"type": "card", "props": {"title": f"Card {i}", "content": f"Content {i}"}} for i in range(50)]
        result = generate_html("Test", components, "default")
