...
from conftest import execute_skill, generate_mockup, save_mockup
...
class TestSaveWithComplexMockups:
    ...
    def test_save_landing_page(self, mock_output_dir):
        ...
        result = generate_mockup({"requirement": "landing page with navbar, hero, grid, and footer", "title": "Landing Page"})
        saved = save_mockup(result, mock_output_dir)
    ...
    def test_save_dashboard(self, mock_output_dir):
        ...
        result = generate_mockup({"requirement": "dashboard with navbar, table, and cards", "theme": "dark"})
        saved = save_mockup(result, mock_output_dir)
    ...
    def test_save_with_many_components(self, mock_output_dir):
        ...
        base_components = [{"type": "navbar", "props": {}}, {"type": "hero", "props": {}}]
...
class TestSaveEdgeCases:
    ...
    def test_save_with_unicode_content(self, mock_output_dir):
        ...
        result = generate_mockup({"requirement": "create navbar with brand 测试应用", "title": "测试页面"})
        saved = save_mockup(result, mock_output_dir)
    ...
    def test_save_with_special_chars_in_title(self, mock_output_dir):
        ...
        result = generate_mockup({"requirement": "navbar", "title": "Test & Demo <2024>"})
        saved = save_mockup(result, mock_output_dir)
...
class TestExecuteSkillWithSave:
    ...
    def test_execute_skill_saves_files(self, mock_output_dir):
        ...
        result = execute_skill({"requirement": "create a navbar", "output_dir": mock_output_dir})
